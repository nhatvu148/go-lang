...
picture_2_group = [["DFP", os.getcwd() + "/images/" + "graph-Stress-1" + ".png"],
                   ...
                   ["SFP", os.getcwd() + "/images/" + "graph-Stress-3" + ".png"],
                   ["SFS", os.getcwd() + "/images/" + "graph-Stress-4" + ".png"],
                   ["DMP", os.getcwd() + "/images/" + "graph-Stress-5" + ".png"],
                   ["DMS", os.getcwd() + "/images/" + "graph-Stress-6" + ".png"],
                   ["SMP", os.getcwd() + "/images/" + "graph-Stress-7" + ".png"],
                   ["SMS", os.getcwd() + "/images/" + "graph-Stress-8" + ".png"],
                   ["DAP", os.getcwd() + "/images/" + "graph-Stress-9" + ".png"],
                   ["DAS", os.getcwd() + "/images/" + "graph-Stress-10" + ".png"],
                   ["SAP", os.getcwd() + "/images/" + "graph-Stress-11" + ".png"],
                   ["SAS", os.getcwd() + "/images/" + "graph-Stress-12" + ".png"],
                   ["L21", os.getcwd() + "/images/" + "graph-Stress-13" + ".png"],
                   ["L22", os.getcwd() + "/images/" + "graph-Stress-14" + ".png"],
                   ["L23", os.getcwd() + "/images/" + "graph-Stress-15" + ".png"],
                   ["L24", os.getcwd() + "/images/" + "graph-Stress-16" + ".png"],
                   ["L25", os.getcwd() + "/images/" + "graph-Stress-17" + ".png"],
                   ["L41", os.getcwd() + "/images/" + "graph-Stress-18" + ".png"],
                   ["L42", os.getcwd() + "/images/" + "graph-Stress-19" + ".png"],
                   ["L43", os.getcwd() + "/images/" + "graph-Stress-20" + ".png"],
                   ["L44", os.getcwd() + "/images/" + "graph-Stress-21" + ".png"],
                   ["L45", os.getcwd() + "/images/" + "graph-Stress-22" + ".png"],
                   ["L46", os.getcwd() + "/images/" + "graph-Stress-23" + ".png"],
                   ["L47", os.getcwd() + "/images/" + "graph-Stress-24" + ".png"],
                   ["L48", os.getcwd() + "/images/" + "graph-Stress-25" + ".png"],
                   ["L49", os.getcwd() + "/images/" + "graph-Stress-26" + ".png"],
                   ["L410", os.getcwd() + "/images/" + "graph-Stress-27" + ".png"],
                   ["L51", os.getcwd() + "/images/" + "graph-Stress-28" + ".png"],
                   ["L52", os.getcwd() + "/images/" + "graph-Stress-29" + ".png"],
                   ["L53", os.getcwd() + "/images/" + "graph-Stress-30" + ".png"],
                   ["L54", os.getcwd() + "/images/" + "graph-Stress-31" + ".png"],
                   ["L55", os.getcwd() + "/images/" + "graph-Stress-32" + ".png"],
                   ["L56", os.getcwd() + "/images/" + "graph-Stress-33" + ".png"],
                   ["L57", os.getcwd() + "/images/" + "graph-Stress-34" + ".png"]]
##
picture_3_group = [["AFx", os.getcwd() + "/images/" + "graph-Stress-35" + ".png"],
                   ["AFy", os.getcwd() + "/images/" + "graph-Stress-36" + ".png"],
                   ["AFz", os.getcwd() + "/images/" + "graph-Stress-37" + ".png"],
                   ["AAx", os.getcwd() + "/images/" + "graph-Stress-38" + ".png"],
                   ["AAy", os.getcwd() + "/images/" + "graph-Stress-39" + ".png"],
                   ["AAz", os.getcwd() + "/images/" + "graph-Stress-40" + ".png"]]
##
...
add_picture(document = doc_file,
            path = os.getcwd() + "/" + "images/graph-Map-1.png",
            align = "Center",
